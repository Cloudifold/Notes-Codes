...
\usepackage{amsfonts}
\usepackage[pdfborder={1 0 1}]{hyperref}
\usepackage{amsthm}
...
\newcommand{\waveE}{\tilde{E}}
\newcommand{\waveC}{\tilde{C}}
\newcommand{\wtl}[1]{\widetilde{#1}}
\newcommand{\Fct}{\mathrm{Funct}}
\newcommand{\rel}{\mathrm{\ \!rel\ \!}}
\newcommand{\qaqmapsfrom}{\leftarrow \raisebox{0.35pt}{\hspace{-5pt}$\shortmid \hspace{2.5pt} $}}
\newcommand{\qaqlongmapsfrom}{\longleftarrow \raisebox{0.35pt}{\hspace{-5pt}$\shortmid \hspace{2.5pt} $}}
...
\newcommand{\Limit}[2]{\limit_\limits{#1 \rightarrow #2}}